...
def test_store_paged_kv_chunk_metadata_perf_and_accuracy():
    ...
    k_cache_bench_new = k_cache.clone()
    v_cache_bench_new = v_cache.clone()
    k_cache_bench_legacy = k_cache.clone()
    v_cache_bench_legacy = v_cache.clone()
...
def test_store_paged_mla_kv(
    ...
    op = MojoStorePagedMLAKVCache._registry.get("ttx")()
